...
class ParseUserTest extends PHPUnit_Framework_TestCase
{
    ...
    public function dtestUserSignUp()
    {
        ...
        $user->setEmail('m.skaik@gmail.com');
        $user->signUp();
        $this->assertTrue($user->isAuthenticated());
    }

    public function dtestLoginSuccess()
    {
        $this->testUserSignUp();
    ...
    public function dtestPasswordReset()
    {
        $user = new ParseUser();
        $user->setUsername('asdf');
        $user->setPassword('zxcv');
    ...
    public function dtestUserAssociations()
    {
        ...
        $this->assertEquals(
            $userAgain->get('testobject')->getObjectId(), $child->getObjectId()
        );
    }

    public function dtestUserQueries()
    {
        ParseTestHelper::clearClass(ParseUser::$parseClassName);
        $user = new ParseUser();
        $user->setUsername('asdf');
    ...
    public function dtestSavingUserThrows()
    {
        $user = new ParseUser();
        $user->setUsername('asdf');
        $user->setPassword('zxcv');
    ...
    public function dtestUserLoadedFromStorageFromSignUp()
    {
        ParseTestHelper::clearClass(ParseUser::$parseClassName);
        $fosco = new ParseUser();
    ...
    public function dtestUserWithMissingUsername()
    {
        $user = new ParseUser();
    ...
    public function dtestUserWithMissingPassword()
    {
        $user = new ParseUser();
        $user->setUsername('test');
